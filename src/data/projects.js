...
import project2Image5 from "../assets/projectsImages/project2/image-5.webp";
...
يقدّم المشروع مزيجًا متقنًا من الاتساع والرفاهية، بمساحات تبدأ من 161 مترًا وتصل إلى 190 مترًا، ضمن تصاميم معمارية عصرية تمنح كل وحدة طابعًا فريدًا يعكس جودة الحياة ورقيّها.
هنا، تلتقي الأناقة بالتفاصيل العملية لتصنع تجربة سكنية متميزة تجمع بين الخصوصية والراحة والفخامة .
