...
export const projects = [
  {
    ...
    description: '4 مباني سكنية تلبي تطلعاتك للسكن العصري في حي العزيزية بالمدينة المنورة.',
    detailedDescription: `
    تولت شركة وسائل النمو إدارة المشروع ضمن منظومة متكاملة تغطي جميع مراحل التطوير والتشغيل العقاري.
...
نحن في وسائل النمو لا نقتصر على إدارة المشاريع فقط، بل نقدم نموذجًا متكاملًا يشمل التطوير، التسويق، إدارة المشاريع، وإدارة الأملاك، لضمان انتقال المشروع بسلاسة من مرحلة التنفيذ إلى أصل استثماري فعّال.
  ...
  },
  {
    ...
    description: 'إدارة وتشغيل عقاري متكامل للأصول الوقفية لضمان أعلى عوائد استثمارية.',
    detailedDescription: 'إدارة وتشغيل عقاري متكامل يشمل الإشراف الفني، التنظيم المالي، والتسويق لضمان أعلى عوائد استثمارية للأصل العقاري، مع الحفاظ على القيمة الوقفية للأصل وضمان استدامته للأجيال القادمة.',
    space: 'حوالي 1050 م²',
  ...
  },
  {
    ...
    description: 'شقق سكنية فاخرة بمساحات واسعة وتصاميم عصرية في أرقى أحياء المدينة المنورة.',
