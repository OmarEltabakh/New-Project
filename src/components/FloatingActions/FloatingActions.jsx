...
const FloatingActions = () => {
  ...
  return (
    <div className="global-floating-actions">
      <a 
        href="https://wa.me/966542231128" 
        target="_blank" 
        rel="noreferrer" 
        className="floating-btn whatsapp-btn"
        data-tooltip={i18n.language === 'en' ? "Contact via WhatsApp" : "تواصل عبر الواتساب"}
      >
      ...
      <Link 
        ...
        data-tooltip={i18n.language === 'en' ? "Contact Us Now" : "تواصل معنا الآن"}
      >
